...
export async function getDashboard(industry?: string, client: DataClient = defaultClient()): Promise<Dashboard> {
  const raw = requireData(await client.rpc('dashboard_summary', {
